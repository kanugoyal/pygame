...
icon = pygame.image.load('ping_pong/icon.png')
pygame.display.set_icon(icon)

# Player Stuff
player_img = pygame.image.load('ping_pong/player.png')
player_X = 10
player_Y_default = height/2 - 100
player_Y_dif = 0

# Ball Stuff
ball_img = pygame.image.load('ping_pong/ball.png')
ball_X = width/2 - 15
ball_Y = height/2 - 15
ball_dir_X = -3
ball_dir_Y = 3
...
# CPU Stuff
cpu_img = pygame.image.load('ping_pong/player.png')
cpu_X = width - 10 - 27
cpu_Y = height/2 - 100
